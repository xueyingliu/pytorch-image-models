...
parser.add_argument('--output', metavar='ONNX_FILE',default='coatnet_nano_rw_224.onnx',
...
parser.add_argument('--checkpoint', default='weights/coatnet.bin', type=str, metavar='PATH',
